...
echo "  1) Full build (meteoris + meteoris_plot + meteoris_config + meteoris_recover_hdf5)"
echo "  2) Recorder-only build (meteoris + meteoris_config + meteoris_recover_hdf5)"
