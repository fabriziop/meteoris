...
into 48 bands and mapped linearly to 80 Hz--5 kHz; relative loudness follows the
current waterfall Min/Max dB controls. Changing the visible frequency limits
therefore changes the RF-offset range being heard. Press `Mute` to suspend the
